...
// Constructeur
Structure::Structure(sf::Int32 _vieMax, sf::Int32 _bouclierMax, float _bouclierTaux, sf::Int32 _visibilite, sf::Int32 _attaque, sf::Int32 _rayonAttaque, sf::Int32 _prixEnergie, sf::Int32 _prixMateriaux){
    ...
    prixEnergie = _prixEnergie;

    prixMateriaux = _prixMateriaux;
...
sf::Int32 Structure::getPrixEnergie() const{
    return prixEnergie;
}

sf::Int32 Structure::getPrixMateriaux() const{
...
void Structure::setPrixEnergie(sf::Int32 const _prix){
